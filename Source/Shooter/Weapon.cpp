...
void AWeapon::OnConstruction(const FTransform& Transform)
{
	...
	FString WeaponTablePath = TEXT("DataTable'/Game/_Game/DataTable/WeaponData.WeaponData'");
...
void AWeapon::ThrowWeapon() {
	...
	//the direction we throw the weapon
...
void AWeapon::UpdateSlideDisplacement()
{
	...
	{
		float ElapsedTime = GetWorldTimerManager().GetTimerElapsed(SlideTimer);
